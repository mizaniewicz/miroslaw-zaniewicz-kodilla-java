...
public class CrudAppTestSuite {
    public static final String BASE_URL = "http://mizaniewicz.github.io";
    ...
    public String createCrudAppTestTask() throws InterruptedException {
        ...
        WebElement contnet = driver.findElement(By.xpath(XPATH_TASK_CONTENT));
        contnet.sendKeys(taskContent);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mizaniewiczspm@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("qazQAZ7&");
